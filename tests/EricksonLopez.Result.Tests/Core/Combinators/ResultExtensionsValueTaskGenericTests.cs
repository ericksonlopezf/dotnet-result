...
public class ResultExtensionsValueTaskGenericTests
{
    ...
    [Fact]
    public async Task Bind_GenericResult_WithFuncValueTaskResultTNext()
    {
    ...
    [Fact]
    public async Task Bind_GenericResult_WithFuncValueTaskResult()
    {
    ...
    [Fact]
    public async Task TapOnSuccess_GenericResult_WithFuncValueTask()
    {
        int count = 0;
    ...
    [Fact]
    public async Task TapOnFailure_GenericResult_WithFuncValueTask()
    {
        int count = 0;
    ...
    [Fact]
    public async Task Recover_GenericResult_WithFuncValueTaskResult()
    {
