...
public class ResultGuardRailTests
{
    [Fact]
    public void Error_Properties_ExposeExpectedMetadata()
    {
    ...
    [Fact]
    public void Result_Ensure_WithLazyError_OnFailure_ReturnsOriginalFailure()
    {
    ...
    [Fact]
    public void ResultOfT_Ensure_WithLazyError_OnFailure_ReturnsOriginalFailure()
    {
        var originalError = Error.Failure("Original", "Original error");
    ...
    [Fact]
    public void StrictErrorComparer_GetHashCode_WithInnerErrors_ComputesNonZeroHash()
    {
