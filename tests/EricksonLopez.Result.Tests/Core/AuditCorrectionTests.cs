...
public class AuditCorrectionTests
{
    ...
    public void CombineOfT_AllSuccess_ReturnsAllValues()
    {
        ...
        Assert.Contains(10, (System.Collections.Generic.IEnumerable<int>)combined.Value);
        Assert.Contains(20, (System.Collections.Generic.IEnumerable<int>)combined.Value);
        Assert.Contains(30, (System.Collections.Generic.IEnumerable<int>)combined.Value);
    }
}
...
internal partial class AuditTestJsonContext : JsonSerializerContext { }
