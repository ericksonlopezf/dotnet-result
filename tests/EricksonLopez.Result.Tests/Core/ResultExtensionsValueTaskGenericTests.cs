...
public class ResultExtensionsValueTaskGenericTests
{
    ...
    [Fact]
    public async Task Bind_FuncResultTNext()
    {
    ...
    [Fact]
    public async Task Bind_TState_FuncResultTNext()
    {
    ...
    [Fact]
    public async Task Bind_FuncValueTaskResultTNext()
    {
        (await S().Bind(v => new ValueTask<Result<int>>(Result.Success(v * 2)))).ShouldBeSuccess().Should().Be(84);
        (await IS().Bind(v => new ValueTask<Result<int>>(Result.Success(v * 2)))).ShouldBeSuccess().Should().Be(84);
        (await F().Bind(v => new ValueTask<Result<int>>(Result.Success(v * 2)))).ShouldBeFailure();
        (await IF().Bind(v => new ValueTask<Result<int>>(Result.Success(v * 2)))).ShouldBeFailure();
    }
    
    [Fact]
    public async Task Bind_FuncValueTaskResult()
    {
        (await S().Bind(v => new ValueTask<Result>(Result.Success()))).ShouldBeSuccess();
        (await IS().Bind(v => new ValueTask<Result>(Result.Success()))).ShouldBeSuccess();
        (await F().Bind(v => new ValueTask<Result>(Result.Success()))).ShouldBeFailure();
        (await IF().Bind(v => new ValueTask<Result>(Result.Success()))).ShouldBeFailure();
    }
    ...
    {
        int count = 0;
        (await S().TapOnSuccess(v => { count += v; return ValueTask.CompletedTask; })).ShouldBeSuccess();
        Assert.Equal(42, count); count = 0;
        (await IS().TapOnSuccess(v => { count += v; return ValueTask.CompletedTask; })).ShouldBeSuccess();
        Assert.Equal(42, count); count = 0;
        (await F().TapOnSuccess(v => { count += v; return ValueTask.CompletedTask; })).ShouldBeFailure();
        Assert.Equal(0, count); count = 0;
        (await IF().TapOnSuccess(v => { count += v; return ValueTask.CompletedTask; })).ShouldBeFailure();
        Assert.Equal(0, count);
    }
    ...
    {
        (await F().Recover(e => new ValueTask<Result<int>>(Result.Success(100)))).ShouldBeSuccess().Should().Be(100);
        (await IF().Recover(e => new ValueTask<Result<int>>(Result.Success(100)))).ShouldBeSuccess().Should().Be(100);
        (await S().Recover(e => new ValueTask<Result<int>>(Result.Failure<int>(Error.Failure("2", "2"))))).ShouldBeSuccess().Should().Be(42);
        (await IS().Recover(e => new ValueTask<Result<int>>(Result.Failure<int>(Error.Failure("2", "2"))))).ShouldBeSuccess().Should().Be(42);
    }
}
