...
public class ResultAssertionsCoverageTests
{
    ...
    public void CallAllResultAssertionsMethods()
    {
        ...
        foreach (var method in type.GetMethods(System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Static))
        {
            ...
            var m = method.IsGenericMethod ? method.MakeGenericMethod(System.Linq.Enumerable.Repeat(typeof(int), method.GetGenericArguments().Length).ToArray()) : method;
            ...
            for (int i = 0; i < args.Length; i++)
            {
                ...
                else if (pt == typeof(System.Threading.Tasks.Task<Result>)) args[i] = System.Threading.Tasks.Task.FromResult(Result.Success());
                else if (pt == typeof(System.Threading.Tasks.Task<Result<int>>)) args[i] = System.Threading.Tasks.Task.FromResult(Result.Success(1));
                else if (pt == typeof(System.Threading.Tasks.ValueTask<Result>)) args[i] = new System.Threading.Tasks.ValueTask<Result>(Result.Success());
                else if (pt == typeof(System.Threading.Tasks.ValueTask<Result<int>>)) args[i] = new System.Threading.Tasks.ValueTask<Result<int>>(Result.Success(1));
            ...
            for (int i = 0; i < args.Length; i++)
            {
                ...
                else if (pt == typeof(System.Threading.Tasks.Task<Result>)) args[i] = System.Threading.Tasks.Task.FromResult(Result.Failure(Error.Failure("X", "X")));
                else if (pt == typeof(System.Threading.Tasks.Task<Result<int>>)) args[i] = System.Threading.Tasks.Task.FromResult(Result.Failure<int>(Error.Failure("X", "X")));
                else if (pt == typeof(System.Threading.Tasks.ValueTask<Result>)) args[i] = new System.Threading.Tasks.ValueTask<Result>(Result.Failure(Error.Failure("X", "X")));
                else if (pt == typeof(System.Threading.Tasks.ValueTask<Result<int>>)) args[i] = new System.Threading.Tasks.ValueTask<Result<int>>(Result.Failure<int>(Error.Failure("X", "X")));
            }
