...
public class MediatRColdStartBenchmarks
{
    ...
    public void MeasureColdStartCompilation()
    {
        for (int i = 0; i < TypesCount; i++)
        {
            ...
            var t = i switch
            {
                0 => typeof(int), 1 => typeof(string), 2 => typeof(Guid),
                3 => typeof(double), 4 => typeof(float), 5 => typeof(decimal),
                6 => typeof(long), 7 => typeof(short), 8 => typeof(byte),
                9 => typeof(bool), 10 => typeof(char), 11 => typeof(DateTime),
                12 => typeof(DateTimeOffset), 13 => typeof(TimeSpan), 14 => typeof(object),
                15 => typeof(System.Text.StringBuilder), 16 => typeof(System.IO.MemoryStream),
                17 => typeof(System.Net.Http.HttpClient), 18 => typeof(System.Threading.CancellationTokenSource),
                19 => typeof(System.Text.RegularExpressions.Regex), 20 => typeof(System.Uri),
                21 => typeof(System.Version), 22 => typeof(System.Type), 23 => typeof(System.Reflection.Assembly),
                24 => typeof(System.Reflection.MethodInfo),
                25 => typeof(Tuple<int, int>), 26 => typeof(Tuple<string, string>),
                27 => typeof(Tuple<Guid, Guid>), 28 => typeof(Tuple<double, double>),
                29 => typeof(Tuple<float, float>), 30 => typeof(Tuple<decimal, decimal>),
                31 => typeof(Tuple<long, long>), 32 => typeof(Tuple<short, short>),
                33 => typeof(Tuple<byte, byte>), 34 => typeof(Tuple<bool, bool>),
                35 => typeof(Tuple<char, char>), 36 => typeof(Tuple<DateTime, DateTime>),
                37 => typeof(Tuple<DateTimeOffset, DateTimeOffset>), 38 => typeof(Tuple<TimeSpan, TimeSpan>),
                39 => typeof(Tuple<object, object>),
                40 => typeof(ValueTuple<int, int>), 41 => typeof(ValueTuple<string, string>),
                42 => typeof(ValueTuple<Guid, Guid>), 43 => typeof(ValueTuple<double, double>),
                44 => typeof(ValueTuple<float, float>), 45 => typeof(ValueTuple<decimal, decimal>),
                46 => typeof(ValueTuple<long, long>), 47 => typeof(ValueTuple<short, short>),
                48 => typeof(ValueTuple<byte, byte>), 49 => typeof(ValueTuple<bool, bool>),
