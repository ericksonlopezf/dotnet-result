...
/// <summary>
/// Represents an exception thrown when a Result assertion fails, using NUnit's <see cref="AssertionException"/>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ResultAssertionNUnitException"/> class with a default message.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ResultAssertionNUnitException"/> class with a specified error message.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ResultAssertionNUnitException"/> class from an existing
