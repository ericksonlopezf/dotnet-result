...
public static class ResultHttpExtensions
{
    ...
    /// <summary>
    /// Converts a failed Result into an ASP.NET Core IResult containing a ProblemDetails response.
    /// </summary>
    ...
    private static string GetRfcSection(int statusCode) => statusCode switch
    {
        ...
        >= 500 => "15.6",  // Unknown 5xx: fall back to generic server error section
        >= 400 => "15.5",  // Unknown 4xx: fall back to generic client error section
        _ => "15"          // Unknown status codes: root RFC section
    };
